...
const AboutProduct = () => {
    return (
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center justify-center min-h-screen">
            <div className="md:col-span-1">
                <div className="max-w-max py-4">

                    <Title title={'About Product'} />
                </div>
                <p className="font-poppins text-[20px] font-[400]  leading-[38px]  text-left text-[#787878]">
